...
function requestVideoSrc($videoId)
{
    ...
    if (isset($mainResponseObject->streamingData->formats[1]->url)) {
        ...
        $videoHtml = sprintf('<video controls class="video-player googlevideo-player" style="width: 427px; height: margin:center;" src="%s">Your browser doesn\'t support HTML5 video. Please update your browser.</video>', $videoLink);
        return $videoHtml;
    } else {
