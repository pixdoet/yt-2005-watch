...
if (!isset($_GET['search'])) {
    ...
    // search "refinements" (aka other suggestions)
    if (isset($mainResponseObject->refinements)) {
        $refinements = $mainResponseObject->refinements;
    }
...
?>
    ...
    <body onload="performOnLoadFunctions();">
        ...
        <div style="color: #333; margin-bottom: 10px;">Related Tags:
            <?php
            if (isset($refinements)) {
                foreach ($refinements as $refinement) {
            ?>
                    <a href="results.php?search=<?php echo $refinement; ?>"><?php echo $refinement; ?></a>
            <?php
                }
            }
            ?>
